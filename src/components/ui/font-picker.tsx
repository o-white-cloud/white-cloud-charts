...
import {CheckIcon, ChevronsUpDown as CaretSortIcon } from 'lucide-react';
    ...
    <Popover open={isOpen} onOpenChange={handleOpenChange}>
      <PopoverTrigger asChild>
        <Button
          ...
          className={cn("group relative justify-between rounded-sm", className)}
        >
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    ...
                    <CaretSortIcon className="ml-2 h-3 w-3 opacity-50" />
                  </Button>
                </DropdownMenuTrigger>
